  ...
  <body>
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="/index.php">Taco Taco</a>
        </div>
    ...
    <div class="container">
      <div class="starter-template">
        ...
        <h1><i>Taco Shops</i></h1>

<iframe height='320' scrolling='no' title='Responsive Google Map' src='hmmaps/taccmap.html' frameborder='no' allowtransparency='true' allowfullscreen='true' style='width: 100%;'>        
</iframe>
