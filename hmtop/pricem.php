...
<p>Because you have some money to spare but dont want to go that cheap good to you
</p>
<BR>
<BR>
...
$sql = "SELECT * FROM  `Food Menu` WHERE  `price` BETWEEN 5 AND 10 ";
