  ...
  <body>
    ...
    <div class="container">
      <div class="starter-template">
        ...
        <h1><i>The Nook Cafe</i></h1>

<iframe height='320' scrolling='no' title='Responsive Google Map' src='hmmaps/nookmap.html' frameborder='no' allowtransparency='true' allowfullscreen='true' style='width: 100%;'>        
</iframe>
...
<p>Inside the University of Houston is a small coffee shop catering to students a supply of caffeine and plenty of desk space to study, mingle and play the many board games available to them. Birth place of okaymunchy.com database project made with &#x2764; thanks.</p>
<BR>
<BR>
...
$sql = "SELECT * FROM  `Food Menu` WHERE  `rest_id` =  '18' ";
...
$sql = "SELECT * FROM  `wifi` WHERE  `wifi_id` =  '18' ";
...
$sql = "SELECT * FROM  `events` WHERE  `event_id` =  '18' ";
...
$sql = "SELECT * FROM  `vendors` WHERE  `vend_id` =  '18' ";
...
$sql = "SELECT * FROM  `staff` WHERE  `staff_id` =  '18' ";
...
$sql = "SELECT * FROM  `Parking` WHERE  `park_id` =  '18' ";
$result = $conn ->query($sql);
...
$sql = "SELECT * FROM  `payment method` WHERE  `payment_id` =  '18' ";
$result = $conn ->query($sql);
...
<iframe height='375' scrolling='yes' title='Responsive Google Map' src='/commentbox/tablescomments/comet2.php' frameborder='no' allowtransparency='true' allowfullscreen='true' style='width: 100%;'>        
</iframe>
